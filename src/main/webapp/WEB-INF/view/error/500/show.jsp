...
<head>
  ...
  <link rel="stylesheet" href="/error/css/style500.css">
</head>
<body>
...
<div class="main-error-page">
  ...
  <h2 class="error-subtitle">
   Have you tried turning it off and on again?
    <p><a href="/" style="text-decoration: none; color: red" class="error-subtitle" >Please, go back this way.</a></p>
  </h2>

 
</div>
<!-- partial -->
  <script  src="/error/js/script500.js"></script>
