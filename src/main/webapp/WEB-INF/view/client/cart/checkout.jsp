                    ...
                    <div class="container-fluid py-5">
                        <div class="container py-5">
                            ...
                            <c:if test="${not empty cartDetails}">
                                <form:form action="/place-order" method="post" modelAttribute="receiverRequest">
                                            ...
                                            <div class="p-4 ">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 form-group mb-3">
                                                        ...
                                                        <form:input class="form-control" path = "receiverName" required = "true" />
                                                    </div>
                                                    <div class="col-12 form-group mb-3">
                                                        <label>Địa chỉ người nhận</label>
                                                        <form:input class="form-control" path = "receiverAddress" required = "true" />
                                                    </div>
                                                    <div class="col-12 form-group mb-3">
                                                        <label>Số điện thoại</label>
                                                        <form:input class="form-control" path = "receiverPhone" required = "true" />
                                                    </div>
                                                    <div class="mt-4">
