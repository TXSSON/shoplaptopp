            ...
            <head>
                ...
                <script>
                    $(document).ready(() => {
                        ...
                        console.log("!")
                        const orgImage1 = "${product.image}";
                        if (orgImage1) {
                            const urlImage = "/images/product/" + orgImage1;
                            avatarPreview.attr("src", urlImage);
                            avatarPreview.css({ "display": "block" });
                            localStorage.setItem('product', urlImage);
                        ...
                        avatarFile.change(function (e) {
                            ...
                            avatarPreview.css({ "display": "block" });
                            localStorage.setItem('product', imgURL);
                            console.log(localStorage.getItem('product'));
                        });
                        const savedAvatar = localStorage.getItem('product');
                        console.log(savedAvatar);
                        if (savedAvatar) {
                            console.log("!")
                            avatarPreview.attr("src", savedAvatar);
                            avatarPreview.css({ "display": "block" });
                        }
                    });
                    console.log("!!!")
